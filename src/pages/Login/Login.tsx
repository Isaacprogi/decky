...
const Login: React.FC = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col items-center justify-center items-center justify-center'>
            <h1 className='text-center font-[500] text-3xl text-gray-500'>Yupi</h1>
            <form onSubmit={handleLogin} className="max-w-md w-full mx-auto mt-8 p-4 rounded">
                ...
                <div className='mb-[1rem]'>
                    <span className='text-[.9rem] text-gray-700'>New to Yupi?</span>{' '}
                    <span onClick={handleRegister} className='font-[500] text-gray-700 hover:text-blue-500 cursor-pointer'>
                        Register
                    </span>
                </div>
                <div className='w-full flex items-center justify-center'>
                    <button
                        type='submit'
                        className="bg-blue-500 text-white py-2 w-[10rem] rounded hover:bg-blue-600 focus:outline-none focus:ring focus:ring-blue-200"
                    >
                        Login
                    </button>
                </div>
